...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        ...
        activity = Activity.objects.create(user=user, type='run', duration=30, date='2025-05-30T00:00:00Z')
...
class WorkoutModelTest(TestCase):
    def test_create_workout(self):
        ...
        workout = Workout.objects.create(user=user, description='Pushups', date='2025-05-30T00:00:00Z')
